...
const KPIS: Kpi[] = [
  { id: 'kpi-active-offer', name: 'Sellers with 1st active offer', description: 'New sellers who published their first active offer.', unit: 'sellers', format: 'number', direction: 'higher_better', aggregation: 'sum', default_target: 12, sort_order: 1, active: true, compute: 'entries', additional: false, risk_grace: 20 },
  { id: 'kpi-first-order', name: 'Sellers with 1st order in 30 days', description: 'Sellers reaching their first order within 30 days of an active offer.', unit: 'sellers', format: 'number', direction: 'higher_better', aggregation: 'sum', default_target: 7, sort_order: 2, active: true, compute: 'entries', additional: false, risk_grace: 20 },
  { id: 'kpi-phh', name: 'PHH account setup', description: 'Seller registered and set up their PHH ads account (logins).', unit: 'sellers', format: 'number', direction: 'higher_better', aggregation: 'sum', default_target: 12, sort_order: 3, active: true, compute: 'entries', additional: false, risk_grace: 20 },
  { id: 'kpi-late-rate', name: 'Late rate per portfolio CCD', description: 'Share of portfolio CCDs delivered late (lower is better).', unit: null, format: 'percent', direction: 'lower_better', aggregation: 'avg', default_target: 5, sort_order: 4, active: true, compute: 'entries', additional: false, risk_grace: 20 },
  { id: 'kpi-fbp', name: 'FBP', description: 'Fulfilled business plan sellers.', unit: null, format: 'number', direction: 'higher_better', aggregation: 'sum', default_target: 5, sort_order: 5, active: true, compute: 'entries', additional: false, risk_grace: 20 },
  { id: 'kpi-phh-live', name: 'PHH live campaign', description: 'Sellers running a live PHH ad campaign (not just set up).', unit: 'sellers', format: 'number', direction: 'higher_better', aggregation: 'sum', default_target: null, sort_order: 6, active: true, compute: 'entries', additional: true, risk_grace: 20 },
  { id: 'kpi-assort', name: 'Planned assortment completeness', description: 'Share of onboarded sellers who activated their declared assortment (≥80% if ≤100 SKUs, ≥50% if >100).', unit: null, format: 'percent', direction: 'higher_better', aggregation: 'avg', default_target: 100, sort_order: 7, active: true, compute: 'assortment', additional: false, risk_grace: 20 },
]
